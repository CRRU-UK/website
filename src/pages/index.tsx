    ...
    <>
      ...
      <section className={styles.highlights}>
        <Link href={homepage.highlightLeftLink} className={styles['highlights-item']}>
          ...
          <span className={styles['highlights-item-subtitle']}>{homepage.highlightLeftSubtitle}</span>
          <Image
        ...
        <Link href={homepage.highlightRightLink} className={styles['highlights-item']}>
          ...
          <span className={styles['highlights-item-subtitle']}>{homepage.highlightRightSubtitle}</span>
          <Image
